...
main(int argc, char **argv)
{
    ...
    pcl::io::loadPCDFile ("/home/janak/Relocalization_pranav/localisation/src/relocalisation/data/area.pcd", MapCloud);
    pcl::io::loadPCDFile ("/home/janak/Relocalization_pranav/localisation/src/relocalisation/data/kitti2.pcd", ScanCloud);
